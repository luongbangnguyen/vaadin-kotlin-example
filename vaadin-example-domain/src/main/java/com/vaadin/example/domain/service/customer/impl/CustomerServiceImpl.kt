package com.vaadin.example.domain.service.customer.impl
...
open class CustomerServiceImpl @Autowired constructor(
    ...
    override fun findById(id: Long): Customer = this.customerElasticRepository.findById(id).orElseGet { throw BusinessException("Customer has $id not found") }
